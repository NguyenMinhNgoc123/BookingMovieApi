...
namespace BOOKING_MOVIE_MIGRATION.Migrations
{
    ...
    [Migration("20231211162722_newUpdateMigrateMovieAndPromtion")]
    partial class newUpdateMigrateMovieAndPromtion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.Combo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<long>("ComboFoodId");
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.Genre", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.MovieGenres", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.Combo", b =>
                {
                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.ComboFood")
                        .WithMany("Combos")
                        .HasForeignKey("ComboFoodId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.Food", "Food")
                        .WithMany()
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.InvoiceDetails", b =>
                {
                    ...
                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.MovieTimeSetting", "MovieTimeSetting")
                        .WithMany()
                        .HasForeignKey("MovieTimeSettingId");
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.MovieGenres", b =>
                {
                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.Genre", "Genre")
                        .WithMany()
