...
namespace BOOKING_MOVIE_MIGRATION.Migrations
{
    ...
    [Migration("20231016214953_Add_colum_release_date")]
    partial class Add_colum_release_date
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOOKING_MOVIE_ENTITY.Entities.Movie", b =>
                {
                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.MovieCinema")
                        .WithMany("Movies")
                        .HasForeignKey("MovieCinemaId");

                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.MovieDateSetting")
                        .WithMany("Movies")
                        .HasForeignKey("MovieDateSettingId");

                    b.HasOne("BOOKING_MOVIE_ENTITY.Entities.MovieRoom")
                        .WithMany("Movies")
